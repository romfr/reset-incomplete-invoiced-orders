    ...
    protected function resetMissingInvoices() {
        ...
        foreach ($readConnection->fetchAll($query) as $orderToFix) {
            $orderResetInvoicedFlagsQuery = 'UPDATE sales_flat_order'
                . ' SET base_discount_invoiced = null, base_shipping_invoiced = null, base_subtotal_invoiced = null,'
                . ' base_tax_invoiced = null, base_total_invoiced = null, base_total_invoiced_cost = null,'
                . ' base_total_paid = null, discount_invoiced = null, shipping_invoiced = null, '
